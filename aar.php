<?php session_start();?>
<?php if($_SESSION["is_premium"] == "b46f550143027819e98e18d88115fde6"):?>
<!DOCTYPE html>
<html>
<head>
	<meta http-equiv="content-type" content="text/html; charset=UTF-8" />
	<meta name="viewport" content="initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, user-scalable=0">
	<title>פאנל משתמש - Cougar.co.il</title>
...
<div class="elfsight-app-fe0e6233-a319-4bea-afcc-453f86492e0f"></div>
...
<table class="block-group" cellpadding="0" cellspacing="0">
			...
			<div style="background-color: rgb(247 60 59);background-image: -webkit-linear-gradient(top, rgba(255, 255, 255, 0.278431) 0%, rgba(0, 0, 0, 0.278431) 100%);background-position: center center;background-repeat: repeat;/* border-radius: 8px; */-moz-border-radius: 8px;">
				<p style="text-align: center;">
	<a href="https://emojipedia.org/warning/" ping="/url?sa=t&amp;source=web&amp;rct=j&amp;url=https://emojipedia.org/warning/&amp;ved=2ahUKEwi7h9mcn7HqAhXOM5oKHTD7BZQQFjAAegQIAhAB" style="color: rgb(102, 0, 153); cursor: pointer; text-decoration-line: none; font-family: arial, sans-serif; font-size: small; text-align: right;"><span dir="ltr" style="unicode-bidi: isolate;">⚠️</span></a><b style="font-size: 16px; color: rgb(255, 255, 255); font-family: rubik; text-align: center;">הינך כעת מחובר לפאנל חינמי</b><a href="https://emojipedia.org/warning/" ping="/url?sa=t&amp;source=web&amp;rct=j&amp;url=https://emojipedia.org/warning/&amp;ved=2ahUKEwi7h9mcn7HqAhXOM5oKHTD7BZQQFjAAegQIAhAB" style="color: rgb(102, 0, 153); cursor: pointer; text-decoration-line: none; font-family: arial, sans-serif; font-size: small; text-align: right;"><span dir="ltr" style="unicode-bidi: isolate;">⚠️</span></a></p>
...
<img alt="סטטוס: 🇮🇱" src="https://i.imgur.com/BpbXiFr_d.webp?maxwidth=640&shape=thumb&fidelity=medium"  />
<!-- LikeBtn.com BEGIN -->
...
<div class="prod-details">ממתינה שתשלח הודעה ותפתיע אותי תיהיה צעיר פרוע ומדליק אוהבת סטלות ולהנות מהחיים!</div><div class="prod-lnk">
                        <a href="https://cougar.co.il/your-plan.html"><label>שלח הודעה</label></a>
...
<?php elseif ($_SESSION["is_premium"] == "b46f550143027819e98e18d88115fde6"):?>
<script>location.href="https://cougar.co.il/signup/premiumpanel.php";</script>
<?php else: ?>
<script>window.location.href="signin1.php"</script>
<?php endif; ?>
